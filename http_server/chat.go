...
func init() {
	GE := gin.Default()
	GE.Static("/static/avatars", config.Config.GetString("staticSrcConfig.staticAvatarPath"))
	GE.Static("/static/files", config.Config.GetString("staticSrcConfig.staticFilesPath"))
